<template>
    <footer>
        ...
        <div class="footer-icon">
            ...
            <a href="https://www.instagram.com/richardalvin36/">
            ...
            <a href="https://www.youtube.com/channel/UCz22nAyzNasxj9aHXvqcNIQ">
        ...
        <div class="footer-copyright">
            <p>Copyright © 2023 RAP Porto</p>
            <a href="#nav" class="scroll-to-top-button">Back To Top</a>
        </div>
    </footer>
</template>
...
.footer-copyright p, .footer-copyright a.scroll.top-topbutton{
    display:inline;
    padding-right: 20px;
    color: white;
}
